                                            ...
                                            <li class="has-dropdown has-dropdown--ul-right-100">
                                                ...
                                                <ul style="width:120px">
                                                    <li>
                                                        ...
                                                        <a class="u-c-brand" href="shop-list-full.php">ENGLISH</a>
                                                    </li>
                                                    
                                                    <li>

                                                        <a href="shop-list-full-Fr.php">FRANCAIS</a>
                                                    </li>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                    ...
                                    <li>
                                        ...
                                        <a href="index.php#HELP">LET US HELP YOU</a>
                                    </li>
                                    <li>

                                        <a href="index.php#TOP_TRENDING">TOP TRENDING</a>
                                    </li>
                                </ul>
                                <!--====== End - List ======-->
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="shop-p">
                                <div class="shop-p__toolbar u-s-m-b-30">
                                    <div class="shop-p__meta-wrap u-s-m-b-60" style="background-color:#ff6700;">

                                        <span class="shop-p__meta-text-1" style="font-size: large;">FOUND <?php include 'resultatNbr.php'; ?> RESULTS</span>
                                        <div class="shop-p__meta-text-2"></div>
                                    </div>
